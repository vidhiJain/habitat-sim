...
TEST(IOTest, JsonEspTypesTest) {
  ...
  ASSERT(state2.absTransform.translation == state.absTransform.translation);
  ASSERT(state2.absTransform.rotation == state.absTransform.rotation);
  ASSERT(state2.semanticId == state.semanticId);
}
