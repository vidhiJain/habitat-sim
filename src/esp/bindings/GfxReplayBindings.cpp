...
void initGfxReplayBindings(py::module& m) {
  py::class_<Player, Player::ptr>(m, "Player")
      .def("get_num_keyframes", &Player::getNumFrames, R"(todo)")

      .def("set_keyframe_index", &Player::setFrame, R"(todo)")

      .def("get_keyframe_index", &Player::getFrameIndex, R"(todo)")
  ...
  py::class_<ReplayManager, ReplayManager::ptr>(m, "ReplayManager")
      ...
      .def("player_load_from_file", &ReplayManager::readKeyframesFromFile,
